  ...
  <section class="todo">
    <div class="todo__container">
      ...
      <nav class="nav">
        ...
        >
        <router-link class="link" :to="{ name: 'statistics' }"
          >Статистика</router-link
        >
      </nav>
      <hr />

      <div v-if="isTodo" class="welcom">
        <p>Здравствуйте!</p>
        ...
        <br />
        <p>
          Вкладка "Добавить задачу" - позволяет добавить новую задачу в список
          задач
        </p>
        <br />
        <p>
          Вкладка "Статистика" - отображает колличество выполненных /
          невыполненных задач
        </p>
      </div>
